...
const DisplayCartItem = ({close}) => {
  ...
  return (
    <section className='bg-red-600 lg:bg-neutral-900 fixed top-0 bottom-0 right-0  left-0  z-50'>
                ...
                cartItem[0] && (
                    <div className='p-2'>
                        <div className='bg-green-700 text-neutral-100 px-4 font-bold text-base py-4 static bottom-3 rounded flex items-center gap-4 justify-between'>
                            ...
                            <button onClick={redirectToCheckoutPage} className='cursor-pointer flex items-center gap-1'>
                                Proceed
